...
const image_source =
  'https://firebasestorage.googleapis.com/v0/b/the-green-initiative.appspot.com/o/The%20Green%20Initiative.png?alt=media&token=dc455bd9-b5bb-4222-b693-f25abb5d0311';
...
class CompletedChallengeModal extends Component {
  ...
  componentWillMount() {
    ...
    this.db
      ...
      .doc(`challenge_${this.props.challengeId}`)
      .get()
      .then(doc => {
        ...
        <Modal isVisible={this.state.isModalVisible} animationIn='zoomInDown'>
          ...
          >
            ...
            <SvgUri
              width='50%'
              height='50%'
              uri='https://firebasestorage.googleapis.com/v0/b/the-green-initiative.appspot.com/o/winner%201.svg?alt=media&token=a80ecd9f-e959-4975-9e70-e8c1d74cd353'
            />
